    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try{
            ...
            if(cursor.getCount() != 0)
            {
                ...
                while(cursor.getPosition() != 0)
                {
                    ...
                    if(int_stress >= 7)
                    {
                        ...
                        while(cursor2.moveToNext())
                        {
                            ...
                            if(int_stress_1 == 10 && b1_10 == false)
                            {
                    ...
                    else if(int_stress < 7 && int_stress >= 3) {

                        Cursor cursor2 = sdb.rawQuery("select stress_1, stress_2, stress_3, stress_4, stress_5 from stress", null);
                        while (cursor2.moveToNext()) {
                            int int_stress_2 = cursor2.getInt(1);

                            if (int_stress_2 == 5 && b2_5 == false)
                            {
                            ...
                            if (int_stress_2 == 10 && b2_10 == false)
                            {
                    ...
                    else if(int_stress < 3 && int_stress >= -2)
                    {
                        ...
                        while (cursor2.moveToNext()) {
                            ...
                            if (int_stress_3 == 10 && b3_10 == false)
                            {
                    ...
                    else if(int_stress < -2 && int_stress >= -6)
                    {
                        ...
                        while (cursor2.moveToNext()) {
                            ...
                            if (int_stress_4 == 10 && b4_10 == false)
                            {
                    ...
                    else
                    {
                        ...
                        while (cursor2.moveToNext()) {
                            ...
                            if (int_stress_5 == 10  && b5_10 == false)
                            {
                ...
                adapter.addItem(ContextCompat.getDrawable(this, R.drawable.price), "반가워요!",
                        "", "\"오늘의 기분을 함께 기록해보세요. 당신의 감정을 알아가는 첫 걸음입니다.\"");
            }
